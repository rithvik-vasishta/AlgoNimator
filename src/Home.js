      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            ...
            <h4>Somandra Singh Rathore</h4>
            <p>Front-end Developer</p>
            <p><a class="btn btn-secondary" href="https://github.com/somandra" role="button">View details »</a></p>
          </div>
          <div class="col-md-3">
          	<img class="rounded-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="Generic placeholder image" width="140" height="140" />
            <h4>Rithvik Vasishta</h4>
            <p>Back-end Developer</p>
            <p><a class="btn btn-secondary" href="https://github.com/rithvik-vasishta" role="button">View details »</a></p>
          </div>
          <div class="col-md-3">
          	<img class="rounded-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="Generic placeholder image" width="140" height="140" />
            <h4>Yash Singh Chouhan</h4>
            <p>Front-end Developer</p>
            <p><a class="btn btn-secondary" href="https://github.com/yashsingh289" role="button">View details »</a></p>
          </div>
          <div class="col-md-3">
          	<img class="rounded-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="Generic placeholder image" width="140" height="140" />
            <h4>Utkarsha Verma</h4>
            <p>Back-end Developer/Presenter</p>
            <p><a class="btn btn-secondary" href="https://github.com/utkarshaverma" role="button">View details »</a></p>
          </div>
        </div>
